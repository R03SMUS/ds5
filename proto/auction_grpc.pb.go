...
type AuctionClient interface {
	...
	Result(ctx context.Context, in *Request, opts ...grpc.CallOption) (*RequestRespone, error)
}
...
func (c *auctionClient) Bid(ctx context.Context, in *BidMessage, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
	err := c.cc.Invoke(ctx, "/mutex.Auction/Bid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *auctionClient) Result(ctx context.Context, in *Request, opts ...grpc.CallOption) (*RequestRespone, error) {
	out := new(RequestRespone)
	err := c.cc.Invoke(ctx, "/mutex.Auction/Result", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuctionServer interface {
	...
	Result(context.Context, *Request) (*RequestRespone, error)
...
func (UnimplementedAuctionServer) Result(context.Context, *Request) (*RequestRespone, error) {
...
func _Auction_Result_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mutex.Auction/Result",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
